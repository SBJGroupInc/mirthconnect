...
{
    /// <summary>
    /// CodeTemplateLibrarySaveResultCauseStackTrace
    /// </summary>
    [DataContract(Name = "CodeTemplateLibrarySaveResult_cause_stackTrace")]
    public partial class CodeTemplateLibrarySaveResultCauseStackTrace : IEquatable<CodeTemplateLibrarySaveResultCauseStackTrace>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CodeTemplateLibrarySaveResultCauseStackTrace" /> class.
        /// </summary>
        ...
        public CodeTemplateLibrarySaveResultCauseStackTrace(string classLoaderName = default(string), string moduleName = default(string), string moduleVersion = default(string), string methodName = default(string), string fileName = default(string), int lineNumber = default(int), string className = default(string), bool nativeMethod = default(bool))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CodeTemplateLibrarySaveResultCauseStackTrace {\n");
        ...
        {
            return this.Equals(input as CodeTemplateLibrarySaveResultCauseStackTrace);
        }

        /// <summary>
        /// Returns true if CodeTemplateLibrarySaveResultCauseStackTrace instances are equal
        /// </summary>
        /// <param name="input">Instance of CodeTemplateLibrarySaveResultCauseStackTrace to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CodeTemplateLibrarySaveResultCauseStackTrace input)
        {
            if (input == null)
            {
                return false;
